...
namespace Gks
{
    public class WaitForAnimationToHalf : CustomYieldInstruction
    {
        ...
        private bool AnimationIsDone => StateInfo.normalizedTime >= 0.5f;
        ...
        public WaitForAnimationToHalf(Animator animator, string animationName, int layerIndex = 0)
        {
